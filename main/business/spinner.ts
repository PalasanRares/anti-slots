...
export class Spinner {
    ...
    public spin(bet: number): SpinResult {
        ...
        for (let _ of rows) {
            ...
            for (let column of columns) {
                ...
                while (
                    wasScatterGenerated[column] &&
                    randomSymbol.modifier === Modifier.Scatter
                ) {
    ...
    private countWinningLines(result: Symbol[][], bet: number): WinningLine[] {
        ...
        let noSymbols = 1;
        while (
            result[0][i].modifier !== Modifier.Scatter &&
            i < noColumns &&
        ...
        noSymbols = 1;
        while (
            result[1][i].modifier !== Modifier.Scatter &&
            i < noColumns &&
        ...
        noSymbols = 1;
        while (
            result[2][i].modifier !== Modifier.Scatter &&
            i < noColumns &&
        ...
        noSymbols = 1;
        while (
            result[0][0].modifier !== Modifier.Scatter &&
            j < noColumns - 1 &&
            result[i][j] === result[i + k][j + 1]
        ) {
            noSymbols += 1;
        ...
        symbol = result[2][0];
        while (
            result[2][0].modifier !== Modifier.Scatter &&
            j < noColumns - 1 &&
            result[i][j] === result[i + k][j + 1]
        ) {
            noSymbols += 1;
